echo "APT::Install-Recommends \"false\";" | sudo tee $CNFDIR/00aptitude
echo "APT::Authentication::TrustCDROM \"false\";" | sudo tee $CNFDIR/00trustcdrom
echo 'APT
{
  NeverAutoRemove
  {
...
which=news
" | sudo tee $APTDIR/listchanges.conf
